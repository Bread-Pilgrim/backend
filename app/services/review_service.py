...
from app.schema.review import MyBakeryReview, ReviewMenu, ReviewPhoto
...
class Review:
    ...
    async def get_bakery_reviews_by_id(
        self, bakery_id: int, cursor_id: int, page_size: int, sort_by: str
    ):
        pass
